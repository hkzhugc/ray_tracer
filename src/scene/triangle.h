...
public:
	...
	Triangle(const size_t& _a, const size_t& _b, const size_t& _c, const size_t& _na, const size_t& _nb, const size_t& _nc, BlinnPhonBSDF* _bsdf, Mesh* _mesh, string _name) :
	...
	bool intersect(Ray &r, Intersection *i, bool ignore_light = false) const;
